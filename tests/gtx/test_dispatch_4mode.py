...
#
"""Wave 0 scaffold for DISP-03 (Mode 1/2/3/4 dispatch routing).

Filled by Phase 3 plan 04. Module-level _RISCV_AVAILABLE detection so that
...
def test_placeholder():
    pytest.skip("Filled by Plan 04 -- placeholder")
