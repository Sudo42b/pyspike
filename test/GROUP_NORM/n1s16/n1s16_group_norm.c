//==================================================================
// n1s16_group_norm — GROUP_NORM for generated 64 x 8 FP16 tensors
// ggml_group_norm(..., num_groups = 1): normalize the whole tensor.
// dst[i] = (x[i] - mean(all x)) / sqrt(var(all x) + eps)
//==================================================================
...

    {
        ...
        __start_plan(nest_id);
            ...
            __start_thread(0);
                ...
                __layernorm(TOTAL_ELEMS, BANK_A, BANK_B, BANK_R, FP16_EPS_1E_5);
