//==================================================================
// n1s16_scale — element-wise scale with 1 NEST x 16 SPUs
// dst[i] = src0[i] * scale, WIDTH x HEIGHT FP16 elements
//
// Scale factor (1 FP16) read from DDR at BASE_DDR_B before __split.
// Work is partitioned as contiguous 16-element SVR chunks across SPUs, with
// partial-byte stores for the final tail chunk.
// Uses __load_svr / __mul_is / __store_svr for SVR-based scalar multiply.
//==================================================================
