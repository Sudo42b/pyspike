//==================================================================
// unary_silu (generated) — element-wise SiLU: y = x * sigmoid(x)
// HEIGHT rows x 8 FP16 elements
// {{HEIGHT}} is substituted by the runner before build_kernel.sh
//==================================================================
                ...
                for (uint8_t tid = 0; tid < SPU_NUM_PER_NEST; tid++) {
                    ...
                    __start_thread(tid);
                        ...
                        for (uint32_t r = 0; r < rows_for_this_tid; r++) {
                            ...
                            // SiLU(x) = x * sigmoid(x). The Level-3 helper
                            // owns the temporary in BANK_B and writes BANK_R.
                            __silu(WIDTH, BANK_A, BANK_B, BANK_R);
