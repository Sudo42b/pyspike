...
// Input — {{M}}/{{K}}/{{N}} substituted by the runner before build.
// A:(M,K) at 0x1000000, B:(N,K) at 0x2000000, R:(M,N) at 0xf000000
// R = A @ B^T (so dst[i,j] = sum_k A[i,k] * B[j,k])
#define I_A_ROW_SIZE                    {{M}}
#define I_H_COL_SIZE                    {{K}}
#define I_B_ROW_SIZE                    {{N}}
