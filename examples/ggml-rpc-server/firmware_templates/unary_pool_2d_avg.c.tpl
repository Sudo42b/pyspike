//==================================================================
// {{OP_NAME}} (generated) — average pool 2d; dynamic shape + inv(K_H*K_W) fp16 fill
// Source: test/POOL_2D/n1s16/n1s16_pool_2d.c
// Template name: unary_pool_2d_avg.c.tpl
//==================================================================
            ...
            for (uint8_t tid = 0; tid < SPU_NUM_PER_NEST; tid++) {
                if (tid == 0) {
                    __start_thread(tid);
                        ...
                        __pool_a(IN_H, IN_W, OUT_H, OUT_W, K_H, K_W, S_H, S_W, FP16_INV_K);
