//==================================================================
// {{OP_NAME}} (generated) — element-wise binary kernel
// dst[i] = op(src0[i], src1[i]), HEIGHT rows x 8 FP16 elements.
// {{HEIGHT}} + {{INTRIN_CALL}} substituted by the runner pre-build.
// Structure mirrors test/ADD/n1s16/n1s16_add_vv.c (ABS-style multi-tile).
//==================================================================
